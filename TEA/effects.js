...
var _user$project$EffectsPlaygound$notifyView = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('TODO: Build the UI that allows sending notification to a specific client id  and receives notifications for another specified client id'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$EffectsPlaygound$NotifyResponse = F2(
	function (a, b) {
		return {status: a, clientid: b};
	});
var _user$project$EffectsPlaygound$notifyResultDecoder = A3(
...
var _user$project$EffectsPlaygound$subscriptions = function (model) {
	var websockets = A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		A2(
...
var _user$project$EffectsPlaygound$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$EffectsPlaygound$initState, _1: _elm_lang$core$Platform_Cmd$none},
		view: _user$project$EffectsPlaygound$notifyView,
		update: _user$project$EffectsPlaygound$notifyUpdate,
		subscriptions: _user$project$EffectsPlaygound$subscriptions
	})();

var Elm = {};
Elm['EffectsPlaygound'] = Elm['EffectsPlaygound'] || {};
if (typeof _user$project$EffectsPlaygound$main !== 'undefined') {
    _user$project$EffectsPlaygound$main(Elm['EffectsPlaygound'], 'EffectsPlaygound', undefined);
}
